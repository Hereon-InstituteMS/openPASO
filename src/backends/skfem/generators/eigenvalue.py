...
KNOWLEDGE = {
    "eigenvalue": {
        ...
        "pitfalls": [
            ...
            "mode 5 is usually behaving correctly. Measured on "
            "this install with ElementTriP1 on a refined "
            "MeshTri, the relative error roughly quadrupled "
            "between the first and the fifth computed mode. "
